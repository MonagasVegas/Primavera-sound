...
<div class=" d-grid gap-2 col-12 mx-auto">
    <button type="button" class="btn btn-outline-light btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal" style={{ color:"white", background: "#FA008D", border: "#FA008D" }}>
        Descubre más
    </button>
...
<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
    ...
    <div class="row">
        ...
        <div class="col-3  col-xs-3  d-lg-none">
            <button style={{ background: "#FA008D", borderRadius:'50%', width:"25px", height:"25px", border:"#FA008D" }}>
    ...
    <div class="row">
        <div class="col">
            <h1>
                <strong>Primavera sound</strong><br/><strong>Buenos Aires 2022</strong>
            </h1>
...
<div class="row ">
    <div class="col-1">
        <button style={{ background: "#FA008D", borderRadius:'50%', width:"28px", height:"28px", border:"#FA008D" }}>
...
<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
    ...
    <div class="row">
        <div class="col box">
            <h6 class="title">
                <strong style={{color: "#FA008D"}}>$2.75
                </strong>Daily Class Access</h6>
            <p>
    ...
    <div class="row">
        <div class="col box">
            <h6 class="title">
                <strong style={{color: "#FA008D"}}>$9.99
                </strong>Weekly Access</h6>
            <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis.
            </p>
        </div>
    ...
    <div class="row">
        <div class="col box">
            <h6 class="title">
                <strong style={{color: "#FA008D"}}>$19.99
                </strong>Monthly Subscription</h6>
            <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis.
            </p>
        </div>
    ...
    <div class="row">
        <div class="col box">
            <h6 class="title">
                <strong style={{color: "#FA008D"}}>$189.99
                </strong>Yearly Subscription</h6>
            <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis.
            </p>
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 " style={{ border: "1px solid #FFFFFF", alignItems: "flex-start", borderRadius: "25px", background:"#FFFFFF" }}>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12      text3">
                <p>
                    Una vez efectuada la compra, recibirás por correo electrónico el link para acceder al evento.
                </p>
                <p>
                ...
                <p>Los tickets no son transferibles.
                </p>
            </div>
        </div>
    </div>
