     ...
     <div class="container-fluid" style={{
      ...
      {/* Contenedor2 */}
        <div class="container-fluid "   style={{ marginTop:"210px"}} >
            ...
            <div class="row"   >
                <div class="col-12 " >
                    <button type="button" onClick={this.handleClick}     class="btn2"> MÁS INFORMACIÓN</button>
                </div>
                <div><br/></div>
                {this.state.value ?
                <div>
    ...
    <div><br/><br/></div>
            ...
            <div class="container-fluid">
                    <div class="row textWhite d-none d-xs-none d-lg-block" >
                        <div class="col-12" >  <h5>Categorías</h5> </div><br/><br/>
                    </div>
                    ...
                    <div class="row d-none d-xs-none d-lg-block" >
                        <div class="col-12 " >   
                           <button type="button" class="btn btn-sm   btn-outline-light">Pasatiempo </button>&nbsp;&nbsp;
